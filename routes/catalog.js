...
router.post('/cd/create', upload.single("cdImage"), cd_controller.cd_create_post);
...
router.post('/author/create', upload.single("authorImage"), author_controller.author_create_post);
